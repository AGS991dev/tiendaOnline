<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master.master" CodeFile="shopStorebkpCarrousel.aspx.vb" Inherits="shop" %>
                                ...
                                <asp:GridView ID="GV_shop" runat="server" class="striped" AutoGenerateColumns="false" CellSpacing='0' Width='100%'>
                                    <Columns>
                                        <asp:TemplateField HeaderText="Articulos">
                                            <ItemTemplate>
                                                <div class="col-md-6">
                                                    <div class="card card_producto" style="width: 230px; margin: 10px; height: 285px;">
                                                        <!-- Contenido de la tarjeta -->
                                                        <!-- Imágenes -->
                                                        <div>
                                                            <div class="owl-carousel owl-theme">
                                                                <div style="width: 125px; padding: 5px; max-height: 200px;">
                                                                    <div class="owl-carousel owl-theme">
                                                                        <img style="max-height: 200px;" class="activator img_producto" src="<%#Eval("ruta_imagen")%>" descripcion="<%#Eval("descripcion")%>" id="<%#Eval("id")%>" nombre="<%#Eval("nombre")%>" precio="<%#Eval("precio")%>" categoria="<%#Eval("categoria")%>" />
                                                                        <img style="max-height: 200px;" class="activator img_producto" src="<%#Eval("ruta_imagen_2")%>" descripcion="<%#Eval("descripcion")%>" id="<%#Eval("id")%>" nombre="<%#Eval("nombre")%>" precio="<%#Eval("precio")%>" categoria="<%#Eval("categoria")%>" />
                                                                        <img style="max-height: 200px;" class="activator img_producto" src="<%#Eval("ruta_imagen_3")%>" descripcion="<%#Eval("descripcion")%>" id="<%#Eval("id")%>" nombre="<%#Eval("nombre")%>" precio="<%#Eval("precio")%>" categoria="<%#Eval("categoria")%>" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div style="padding: 5px 15px;">
                                                            <span style=""><%#Eval("nombre")%></span>
                                                            <p><%#Eval("categoria")%></p>
                                                        </div>
                                                        <div style="padding: 0px 15px; position: absolute; bottom: 0; width: 230px;">
                                                            <span style="font-family: Bangers; font-size: 30px; position: relative; top: -2px;">$<%#Eval("precio")%>.00</span>
                                                            <span id='btn_comprar' url='Grilla_carrito.aspx' obj_id='<%#Eval("id")%>' img="<%#Eval("ruta_imagen")%>" art_id="<%#Eval("id")%>" precio="<%#Eval("precio")%>" onclick='agregar_al_carrito_busqueda(this,"Producto agregado Correctamente");'>
                                                                <span class='tooltipped' data-position='right' data-tooltip='Agregar'>
                                                                    <img class="zoom css_cesta" src="./static/img/cesta2.png" style="width: 35px;" />
                                                                </span>
                                                            </span>
                                                        </div>
                                                    </div>
