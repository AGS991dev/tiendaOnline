<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/master.master" CodeFile="Grilla_mas_visitados.aspx.vb" Inherits="Grilla_mas_visitados" %>

<asp:Content runat="server" ContentPlaceHolderID="contenido_nav">
    <a href="supervisor_index.aspx" class="breadcrumb">INICIO</a>
    <a href="#" class="breadcrumb ACTIVE">MÁS VISITADOS</a>
</asp:Content>

<asp:Content runat="server" ContentPlaceHolderID="contenido_body">

    <h1 style="text-align:center">Productos más visitados</h1>
    <p class="center">Aquí verás la cantidad de veces que un producto entró dentro de un carrito</p>
        <div >
        ...
        <form id="Form_fv_empresas" runat="server">
                    ...
                    <asp:HiddenField id="hi_input" runat="server" Value="" />
                                    ...
                                    <div class="contender_carrito" style="position: absolute; top: 17vh; right: 15vw;">
                                        <img src="./static/img/amor.png" class="img_carrito bounce" style="width: 80px;"/>
                                    </div>
                                        <!---->
                                        <div style="margin:20px">
                                            <div class="card" style="min-height:70vh;padding: 30px;">
                                                ...
                                                <br />
                                                    <asp:UpdatePanel ID="panel_visitados" runat="server" style="margin: 1em;min-width: 380px;" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                       <% If tabla_vacia = True Then %>
                                                        ...
                                                        <%End if %>
                                                    <ASP:GridView ID ="GV_visitados" runat="server" class="table" AutoGenerateColumns="false"  CellSpacing='0' Width='100%'>
                                                        <Columns>
                                                           <ASP:BoundField DataField = "Puesto" htmlencode="false" HeaderText="PUESTO" />
                                                           <ASP:BoundField DataField = "categoria" htmlencode="false" HeaderText="CATEGORÍA" />
                                                           <ASP:BoundField DataField = "nombre" htmlencode="false" HeaderText="PRODUCTO" />
                                                           <ASP:BoundField DataField = "Precio" htmlencode="false" HeaderText="PRECIO" />
                                                           <ASP:BoundField DataField = "producto_visitado" htmlencode="false" HeaderText="CANTIDAD VISITAS" />
                                                        </Columns>
                                                     </asp:GridView>
                                                     <!---->
                                                     </ContentTemplate>
    ...
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            function refresh_filter() {
                var selector = $('.table')
                inicializar_grilla_orderBy(selector, console.log('Grilla Visitados'), true, 4, "desc")
            }
            refresh_filter()
