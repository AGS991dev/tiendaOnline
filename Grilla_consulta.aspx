                                                    ...
                                                    <asp:UpdatePanel ID="panel_btn_filtrar" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            ...
                                                            <div style="display:flex;gap:10px">
                                                                ...
                                                                <asp:Button AutoPostBack="true" style="margin: 0px 20px; position: relative; top: 10px; height: 36px; background: #ff76a2;" ID="btn_filtrar" runat="server" name="btn_filtrar" CssClass="btn btn_filtrar" Text="Consultar" />
                                                            </div>
                                                        </ContentTemplate>
                                                        <Triggers>
